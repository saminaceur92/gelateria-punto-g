...
export const cakeRecipes = [
  ...
  {
    name: 'Nocciola e caffè',
    shape: 'tonda',
    flavors: ['Nocciola', 'Caffè'],
    filling: 'cremino',
    covering: 'panna',
    decoration: 'macarons',
  },
  ...
  {
    name: 'Pesca al caramello',
    flavors: ['Pesca', 'Caramello Salato'],
    filling: 'granella',
    covering: 'naked',
